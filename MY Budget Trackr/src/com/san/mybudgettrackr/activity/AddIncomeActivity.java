...
public class AddIncomeActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getActionBar().setTitle("Add Income");
		...
		linIn = (LinearLayout) findViewById(R.id.linIn);
		lisIn = (ListView) findViewById(R.id.lisIn);
		...
		save.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				if(price.getText().toString().equals("")){
					Message.message(AddIncomeActivity.this, "Please fill in the blank!");
				}else{
				...
				if(id>0){
					Message.message(AddIncomeActivity.this, "Saved");
				}
				setResult(RESULT_OK);
				finish();
				}
		...
		linIn.setOnTouchListener(new OnTouchListener() 
		{
		...
		lisIn.setOnTouchListener(new OnTouchListener() 
		{
			@SuppressLint("ClickableViewAccessibility") @Override
			public boolean onTouch(View v, MotionEvent me) 
			{
